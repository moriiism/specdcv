#ifndef SPECDCV_MKRESP_ARG_MKRESP_NP_H_
#define SPECDCV_MKRESP_ARG_MKRESP_NP_H_

#include "mi_base.h"

class ArgValMkrespNp : public MiArgBase{
public:
    ArgValMkrespNp() :
        MiArgBase(),
        progname_(""),
...
#endif // SPECDCV_MKRESP_ARG_MKRESP_NP_H_

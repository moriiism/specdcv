...
void ArgValMkrespNg::Init(int argc, char* argv[])
{
    progname_ = "mkresp";
...
void ArgValMkrespNg::Print(FILE* fp) const
{
...
void ArgValMkrespNg::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValMkrespNg::Usage(FILE* fp) const
{
    fprintf(fp,

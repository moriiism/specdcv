...
void ArgValMkrespPointNg::Init(int argc, char* argv[])
{
    progname_ = "mkresp_point_ng";
...
void ArgValMkrespPointNg::Print(FILE* fp) const
{
...
void ArgValMkrespPointNg::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValMkrespPointNg::Usage(FILE* fp) const
{
    fprintf(fp,
